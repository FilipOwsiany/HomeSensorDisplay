...
SRC_URI += "file://hcsr501-modprobe.conf"
SRC_URI += "file://hcsr501-modules-load.conf"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/hcsr501-modprobe.conf ${D}${sysconfdir}/modprobe.d/hcsr501.conf

    install -d ${D}${sysconfdir}/modules-load.d
    install -m 0644 ${WORKDIR}/hcsr501-modules-load.conf ${D}${sysconfdir}/modules-load.d/hcsr501.conf
